...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference("Component.count") do
      post components_url, params: { component: { kind: @component.kind, max_value: @component.max_value, min_value: @component.min_value, name: @component.name, port: @component.port } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { kind: @component.kind, max_value: @component.max_value, min_value: @component.min_value, name: @component.name, port: @component.port } }
