...
class OutputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create output" do
    assert_difference("Output.count") do
      post outputs_url, params: { output: { component_id: @output.component_id, kind: @output.kind, value: @output.value } }
    end
  ...
  test "should update output" do
    patch output_url(@output), params: { output: { component_id: @output.component_id, kind: @output.kind, value: @output.value } }
