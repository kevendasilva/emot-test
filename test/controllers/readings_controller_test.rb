...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference("Reading.count") do
      post readings_url, params: { reading: { component_id: @reading.component_id, value: @reading.value } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { component_id: @reading.component_id, value: @reading.value } }
